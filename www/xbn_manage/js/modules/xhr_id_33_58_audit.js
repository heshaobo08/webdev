...
(function (X) {
    ...
    // dom event 初始化
    joinCtrl.on('dom_init_event',function(ele,d){
        //实名认证
                   ...
                   if(data.data.status != "false"){
                       $.layer({
                            ...
                            dialog:{
                                ...
                                yes:function(index){
                                    joinCtrl.request({
                                        data:JSON.stringify({id:joinId,idcardstatus:1}),
        ...
        // 审核驳回
        $('.js-UserjoinUnPass',ele).off().on('click',function(){
        ...
        // 审核通过
        $('.js-UserjoinPass',ele).off().on('click',function(){
            var id=$(this).attr('data-id');
            $.layer({
                title:'入驻申请审核通过',
                area: ['500px', '200px'],
        ...
        //设置平台使用费
        $('.js-setPlatFee',ele).off().on('click',function(){
            $.layer({
                title : '平台使用费设置',
                area : ['550px', '180px'],
                dialog : {
