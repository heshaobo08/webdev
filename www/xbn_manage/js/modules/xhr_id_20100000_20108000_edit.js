...
(function (X) {
    ...
    var request = customerService.utils.getRequest();//{ m:"xhr_id_20100000_20101000",  id:"1"}
    ...
    customerServiceCtrl.on('addCustomerFormRender', function () {
        $('#addCustomerForm').html5Validate(function () {
            ...
            customerServiceCtrl.request({
                ...
                if (data.statusCode == '2000000') {
                    customerServiceCtrl.tirgger('setTipsCommit', '客服修改成功！', function () {
