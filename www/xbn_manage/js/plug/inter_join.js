    ...
    a.fn.citySelect = function (b) {
        ...
        function c(b) {
            ...
            d.unbind("click").click(function (e) {
                    a(this).toggleClass(e);
                    f.stop(!0, !0).slideToggle();
        ...
        if (a.fn.removelist = function (b) {
                ...
                return d.removeAll ? f.remove() : g.remove(),
                    k.text(m[d.thisindex]),
                    l.val(m[d.thisindex]),
                    this

            },
            a.fn.appendlist = function (b) {
                var pId = $(this).closest(".dlSele")[0].id;
            console.log(pId);
            console.log(a.fn.citySelect[pId]);
                var c,
                    d = {
                        theindex: "0"
                    },
                    ...
                    f = a(this),
                    g = a("ul", f),
                    h = a.fn.citySelect[pId][e.theindex], //dsy[e.theindex],
                    i = "";

                if ("undefined" == typeof h) return !1;
                for (c = 0; c < h.length; c++)
                    i += '<li><a href="javascript:void(0)" alt="' + h[c] + '">' + h[c] + "</a></li>";
                g.append(i),
                    i = "";
                ...
                a("li", g[0]).on("click",
                        function () {
                            ...
                            return d.text(c),
                                ...
                                b,
                                d.removeClass("lightGray");
                        }),
                    a("ul", g[1]).on("click", "li",
                        function () {
                            ...
                            return e.text(d),
                                ...
                                c,
                                e.removeClass("lightGray");
                        }),
                    a("ul", g[2]).on("click", "li",
                        function () {
            ...
            // a.fn.default = function () {
            //     var b = n[0],
            //         c = n[1],
            //         d;

            //     if (_attr.setText != undefined) {
            //         a(g[1]).appendlist({
            //                 theindex: "0_" + b
            //             }),
            //             a(g[2]).appendlist({
